                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update', ['id' => Auth::user()->id]) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="house" type="text" class="form-control @error('house') is-invalid @enderror" name="house" value="{{ Auth::user()->house }}" required autocomplete="house" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="date" class="form-control @error('city') is-invalid @enderror" name="dob" value="{{ Auth::user()->dob }}" required autocomplete="dob" autofocus>
