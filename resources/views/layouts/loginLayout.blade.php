...
<head>
    ...
    <title>Scoops Troop - Login</title>
...
input, select {
    ...
    padding: 12px 15px 12px 40px; /* Adjust padding-left for the icon */
    margin: 8px 0;
    width: 18em; /* Set all elements to 100% width */
...
/* Style for focused input fields and select */
input:focus, select:focus {
    outline: none; /* Remove the default focus outline */
    border-color: #FF4B2B; /* Change border color on focus */
    box-shadow: 0px 0px 5px 0px #FF4B2B; /* Add a subtle box-shadow on focus */
}

/* Style for the icon prefix */
.input-group {
    position: relative;
}
...
<script>
    ...
    document.getElementById('loginForm').addEventListener('submit', function (event) {
        ...
        // Store the selected region in session storage
