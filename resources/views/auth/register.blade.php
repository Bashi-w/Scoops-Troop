...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
            <center><img src="{{ asset('assets/img/i2.png') }}" alt="logo" class="logo"></center>
            <br>
            <center><h3><b>Register</b></h3></center>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="house" class="col-md-4 col-form-label text-md-end">{{ __('House Number') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="date" class="form-control @error('city') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required autocomplete="dob" autofocus>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn-regster">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
                        <br>
                    <center><b><p>Have an account? <a href="{{ route('login') }}" style="color:black;">Login!</a></p></b></center>
                    </form>
                </div>
            </div>
        </div>
